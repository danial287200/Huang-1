...
# إعدادات الصفحة الأساسية لتكون متجاوبة
st.set_page_config(
...
# كود CSS لإخفاء عناصر Streamlit الزائدة وجعل المحتوى ملء الشاشة
st.markdown("""
<style>
...
# محتوى الـ HTML والـ CSS والـ JavaScript الخاص بالواجهة الصينية
html_content = """
<!DOCTYPE html>
<html lang="zh-CN">
<head>
